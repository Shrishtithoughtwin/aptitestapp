  ...
  return (
      ...
      <div className="container mx-auto p-6 text-center">
        ...
        <div className="flex-1 text-left  ml-2">
          <h2 className="text-lg  mb-1">Online Test - 1 (Averages )</h2>
      ...
      {/* Online Test 2 */}
      <div className="border border-gray-200  p-1 mb-2 flex justify-between items-center w-4/5 mx-auto" onClick={handleTakeTestClick}>
        <div className="flex-1 text-left  ml-2">
          <h2 className="text-lg mb-1">Online Test - 2 (Averages )</h2>
          <p className="text-gray-500 mb-1 text-base">
            Number of questions: 20 | Time: 30 minutes
          </p>
        </div>
        <button className="bg-blue-500 text-white px-4 py-1 rounded-3xl mr-2 hover:bg-blue-600">
          TAKE TEST
        </button>
      </div>
