const TestInstruction = () => {
    return (
      <div className="container mx-auto p-6 text-center shadow-lg rounded-lg bg-base-100 border border-gray-200">
        <h1 className="text-3xl font-bold mb-4">Aptitude Question and Answers Test</h1>
        ...
        <li className="flex items-start">
          <span className="w-2 h-2 bg-blue-400 inline-block mr-2 mt-2"></span>
          <span>
            <span className="font-medium">Negative marks per question:</span> 0.25
          </span>
        </li>
        <li className="flex items-start">
          <span className="w-2 h-2 bg-blue-400 inline-block mr-2 mt-2"></span>
          <span>
            <span className="font-medium">Skipping questions:</span> No marks will be deducted
          </span>
        </li>
        ...
        <button className="flex items-start bg-blue-500 text-white px-5 py-2 rounded-3xl mr-2 hover:bg-blue-600 ">
            Start Test</button>
      </div>
    );
  };
